...
INSERT INTO valueflows.relationship (subject_id, object_id, relationship_type) VALUES
    (uuid('9ee4199b-1c44-40b3-b1f1-109415ddb640'), uuid('1028f159-df2b-4d40-b12c-9fcebd0f4c3d'), 'MemberOf'),
    (uuid('779e3356-5809-4b65-a1b0-81d0c5afc387'), uuid('1028f159-df2b-4d40-b12c-9fcebd0f4c3d'), 'MemberOf'),
    (uuid('0b01d056-20d2-4c69-a022-ea08d9c219dd'), uuid('1028f159-df2b-4d40-b12c-9fcebd0f4c3d'), 'MemberOf'),
    (uuid('31a3601c-c0ba-432f-b921-1b0efb879dd2'), uuid('1028f159-df2b-4d40-b12c-9fcebd0f4c3d'), 'MemberOf'),
    (uuid('63400d04-ebb4-4c6f-8c48-fc209f6c553b'), uuid('9ee4199b-1c44-40b3-b1f1-109415ddb640'), 'MemberOf'),
    (uuid('e391df77-eb5d-455d-88c6-fb93fe3e0073'), uuid('779e3356-5809-4b65-a1b0-81d0c5afc387'), 'MemberOf'),
    (uuid('86e80ff9-5335-4bbe-a7cf-df0b4629a2b3'), uuid('e391df77-eb5d-455d-88c6-fb93fe3e0073'), 'MemberOf'),
    (uuid('86e80ff9-5335-4bbe-a7cf-df0b4629a2b3'), uuid('0b01d056-20d2-4c69-a022-ea08d9c219dd'), 'MemberOf');
