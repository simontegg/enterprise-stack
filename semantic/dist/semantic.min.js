          ...
          settings: function () {
            if (e.isPlainObject(t)) {
              var n,
                ...
                o =
                  i.length > 0 &&
                  (void 0 !== t[i[0]].identifier && void 0 !== t[i[0]].rules)
              o
                ? (
    ...
    rules: {
      ...
      is: function (e, t) {
        return (t = 'string' == typeof t
          ? t.toLowerCase()
          : t), (e = 'string' == typeof e ? e.toLowerCase() : e) == t
      },
      ...
      contains: function (t, n) {
        return (n = n.replace(e.fn.form.settings.regExp.escape, '\\$&')), -1 !==
          t.search(new RegExp(n, 'i'))
      },
      containsExactly: function (t, n) {
        return (n = n.replace(e.fn.form.settings.regExp.escape, '\\$&')), -1 !==
          t.search(new RegExp(n))
      },
      ...
      exactCount: function (e, t) {
        return 0 == t
          ? '' === e
          : 1 == t ? '' !== e && -1 === e.search(',') : e.split(',').length == t
      },
      ...
      ;(w = {
        ...
        setup: {
          ...
          reference: function () {
            w.debug(
              ...
              O.dropdown
            )), w.refresh(), w.setup.returnedObject(), f &&
              ((K = w), w.invoke(d))
          },
        ...
        filter: function (e) {
          var t = void 0 !== e ? e : w.get.query(),
            n = function () {
              w.is.multiple() &&
                w.filterActive(), w.select.firstUnfiltered(), w.has.allResultsFiltered()
            ...
            (
              ...
              Q.each(function () {
                ...
                if ('both' == k.match || 'text' == k.match) {
                  if (
                    ((t = String(w.get.choiceText(r, !1))), -1 !== t.search(a))
                  )
                ...
                if ('both' == k.match || 'value' == k.match) {
                  if (
                    ((o = String(w.get.choiceValue(r, t))), -1 !== o.search(a))
                  )
                    return i.push(this), !0
        ...
        set: {
          ...
          direction: function (e) {
            'auto' == k.direction
              ? w.is.onScreen(e) ? w.remove.upward(e) : w.set.upward(e)
        ...
        add: {
          label: function (t, n, i) {
            ...
            k.label.variation && o.addClass(k.label.variation), !0 === i
              ? (
      ...
      ;(k = {
        ...
        create: {
          dimmer: function () {
            ...
            k.debug('Creating dimmer with settings', n), (b = D.dimmer(
              n
            )), S.detachable
              ? (
              ...
              : k.set.undetached(), S.blurring &&
              b.addClass(A.blurring), (y = b.dimmer('get dimmer'))
          },
          id: function () {
        ...
        show: function (t) {
          ;(t = e.isFunction(t)
            ? t
            : function () {}), k.refreshModals(), k.showModal(t)
        },
        hide: function (t) {
          ;(t = e.isFunction(t)
            ? t
        ...
        set: {
          ...
          position: function () {
            k.verbose('Centering modal on page', k.cache), k.can.fit()
              ? O.css({ top: '', marginTop: -k.cache.height / 2 })
        ...
        bind: {
          ...
          close: function () {
            ;(!0 === x.hideOnScroll ||
              ...
              F.one(y.get.scrollEvent() + h, y.event.hideGracefully), 'hover' ==
              x.on &&
              z &&
              (
      ...
      ;(f = {
        ...
        get: {
          ...
          result: function (t, n) {
            var i = ['title', 'id'],
              o = !1
            return (t = void 0 !== t ? t : f.get.value()), (n = void 0 !== n
              ? n
              : f.get.results()), 'category' === m.type
              ? (
        ...
        search: {
          ...
          object: function (t, n, i) {
            ...
            return (n = n || m.source), (i = void 0 !== i
              ? i
              : m.searchFields), e.isArray(i) || (i = [i]), void 0 === n ||
              !1 === n
              ? (f.error(y.source), [])
              : (
      ...
      ;(m = {
        ...
        set: {
          defaultSide: function () {
            ;(t = w.find('.' + v.className.active)), (f = t.next(h.side)
              .length > 0
              ? t.next(h.side)
          ...
          duration: function (e) {
            ;(e = e || v.duration), (e = 'number' == typeof e
              ? e + 'ms'
              : e), m.verbose('Setting animation duration', e), (v.duration ||
              0 === v.duration) &&
              k.add(S).css({
      ...
      ;(C = {
        initialize: function () {
          C.debug(
            ...
            i
          ), C.create.id(), (x = C.get.transitionEvent()), C.is.ios() &&
            C.set.ios(), w.delaySetup
            ? p(C.setup.layout)
      ...
      ;(v = {
        ...
        save: {
          ...
          positions: function () {
            ...
            }), v.set.containerSize(), v.set.size(), v.stick(), v.debug(
        ...
        fixTop: function () {
          ...
          ), v.set.minimumSize(), v.set.offset(), w
      ...
      ;(x = {
        ...
        delay: function (e) {
          ...
          a ||
            (a = x.can.transition()
              ? x.get.direction()
              : 'static'), (e = void 0 !== e ? e : f.interval), (n =
            'auto' == f.reverse && a == v.outward), (i = n || 1 == f.reverse
            ? (o.length - t) * f.interval
            : t * f.interval), x.debug('Delaying animation by', i), setTimeout(
            x.animate,
            i
          )
        },
        ...
        set: {
          ...
          duration: function (e, t) {
            ;(t = t || f.duration), ((t = 'number' == typeof t
              ? t + 'ms'
              : t) ||
              0 === t) &&
              (
        ...
        get: {
          ...
          settings: function () {
            ...
            return (t = v.beforeSend.call(R, v)), t &&
              ...
              ), void 0 === t && g.error(y.noReturnedValue), !1 === t
              ? t
      ...
      ;(p = {
        ...
        save: {
          ...
          direction: function () {
            ...
            return (e = t > n && n
              ? 'down'
              : t < n && n ? 'up' : 'static'), (p.cache.direction = e), p.cache
              .direction
          },
